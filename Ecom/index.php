...
<head>
    ...
    <title>Toy Heaven Home Page</title>
...
<body>
    ...
    <div id="bannerSlider" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./assets/images/7790552.jpg" class="d-block" style="width: 40%; height: 30%; margin-left: auto; margin-right: auto;" alt="Banner 1">

            </div>
            <div class="carousel-item">
                <img src="./assets/images/7790552.jpg" style="width: 40%; height: 30%; margin-left: auto; margin-right: auto;" alt="Banner 2">
    ...
    <div class="category">
        <div class="container">
            ...
            <div class="cards">
                <div class="card">
                    <image src="./assets/images/download1.png" style=" width: 70px;">
                        <span>Soft Toys</span>
                </div>
                <div class="card">
                    <image src="./assets/images/download2.png" style=" width: 70px;">

                        <span>Action Figures</span>
                </div>
                <div class="card">
                    <image src="./assets/images/download 3.png" style=" width: 70px;">
                        <span>Diy Caste</span>
                </div>
                <div class="card">
                    <image src="./assets/images/download4.png" style=" width: 70px;">
                        <span>puzzles</span>
                </div>
                <div class="card">
                <image src="./assets/images/game.png" style=" width: 70px;">
                    <span>Gaming</span>
                </div>
                <div class="card">
                    <image src="./assets/images/sports.png" style=" width: 70px;">
                        <span>Sports</span>
                </div>
